...
function k(a){a=devtools.utilities.load(a);return a.length?a.split(","):[]}function f(a){a?t.addClass("chrome firefox internet-explorer opera safari"):t.removeClass("chrome firefox internet-explorer opera safari").addClass(g.join(" "))}function n(){b(".secret-count").find("span").html(devtools.posts.countAvailablePosts(u))}function m(b){b&&b.preventDefault();c=d(c,q);devtools.utilities.save("categoryFilters",c.join(","));a.filterPosts()}function p(b){b&&b.preventDefault();g=d(g,r);devtools.utilities.save("browserFilters",
g.join(","));f();a.filterPosts()}function h(){u.each(function(){for(var a=b(this),d=0,e=0,f=a.data("categories"),h=a.data("browsers"),k=!1,l=!1,d=0,e=c.length;d<e;d++)if(0<=f.indexOf(c[d])){k=!0;break}d=0;for(e=g.length;d<e;d++)if(0<=h.indexOf(g[d])){l=!0;break}k&&l?a.show():a.hide()});devtools.posts.toggleSections()}function s(a){var c={};a.preventDefault();c=b(this).find("input:checkbox");c.is(":checked")?c.prop("checked",""):c.prop("checked","checkbox");c.trigger("change");n()}var c=[],g=[],q=
b(".type-selections").find("input:checkbox"),r=b(".browser-selections").find("input:checkbox"),t=b(".controller"),v=b(".selections li"),u=b(".post");a.updateSecretCount=n;a.filterPosts=h;a.init=function(){v.on("click",s);q.on("change",m);r.on("change",p);c=k("categoryFilters");g=k("browserFilters");devtools.utilities.firstVisit?(e(c,q),e(g,r),m(),p()):(0===c.length?e(c,q):l(c,q),0===g.length?(e(g,r),f(!0)):(l(g,r),f()));n();h()}})(devtools.filters=devtools.filters||{},jQuery);devtools.core.init();
